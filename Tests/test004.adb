...
package body test004 is
   ...
   begin
      ...
      nav_interface.set_heading (130.0);
      ...
      tests.check ("Velocity", Float(aircraft.status.velocity), 450.0,  10.0);
      tests.check ("Heading" , Float(aircraft.status.heading),  130.0,    3.0);
