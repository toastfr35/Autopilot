...
package body AFDS.heading is
   ...
   -- for detecting changes in target heading
   ...
   function heading_correction return t_heading_correction is
      current : constant t_heading := AFDS.iface.ACS.data.heading;
      target : constant t_heading := AFDS.iface.AFDS.data.nav_target.heading;
      error : t_heading;
